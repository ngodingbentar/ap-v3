...
export default function ProfileScreen() {
  ...
  }, [dispatch, userInfo._id, user, cities, provincies, tabProfile, successUpdate, initialAddress, isUpdate]);
  
  const submitHandler = (e) => {
    e.preventDefault();
    // console.log('phone', phone, labelAddress)
  ...
  return (
    <div>
      <div className="center-div mt-2">
        ...
        <Button onClick={()=> setTabProfile('password')}>Password</Button>
            ...
            <div>
              ...
              {editAddress ? (
                <div className="center-div">
                  ...
                  <button onClick={() => submitHandlerAlamat()} className="primary text-white w-half" style={{width: 100}}>
                    <b>Update</b>
                  </button>
                </div>
              ) : (
      ...
      {tabProfile === 'password' && (
        ...
        {loading ? (
          ...
          <>
            ...
            <div>
              <label />
              <button onClick={() => submitPassword()} className="primary text-white" style={{width: 150}} >
                <b>Update Password</b>
              </button>
            </div>
          </>
